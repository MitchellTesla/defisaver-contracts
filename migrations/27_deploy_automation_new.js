...
module.exports = async (deployer, network, accounts) => {
    ...
    await registry.changeInsant(web3.utils.keccak256('McdPayback'), mcdPaybackAddress);

    // const mcdSupplyAddress = (await McdSupply.deployed()).address;
    // await registry.changeInsant(web3.utils.keccak256('McdSupply'), mcdSupplyAddress);
